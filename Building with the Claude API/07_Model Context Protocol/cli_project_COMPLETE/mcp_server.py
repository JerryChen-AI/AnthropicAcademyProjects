...
# in cmd, to only test the mcp server when you are developing
# #####################

#create a mcp server!
mcp = FastMCP("DocumentMCP", log_level="ERROR")

# key is the doc_id for you to put on your mcp server. (mcp dev mcp_server.py)
docs = {
...
def read_document( doc_id: str = Field(description="Id of the document to read"),):
    ...
    #Jerry
    print("MCP_Server:","read_document called, doc_id:", doc_id)
    return docs[doc_id]
...
def list_docs() -> list[str]:
    print("MCP_Server:","list_docs called")
...
# Your "Better or Profession" prompt can save as a official prompt in MCP server
@mcp.prompt(
    name="format",
